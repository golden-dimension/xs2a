...
import de.adorsys.psd2.xs2a.config.factory.ReadPaymentStatusConstant;
...
public class PaymentServiceResolverSupport implements PaymentServiceResolver {
    ...
    public ReadPaymentStatusService getReadPaymentStatusService(PisCommonPaymentResponse pisCommonPaymentResponse) {
        ...
        return readPaymentStatusFactory.getService(ReadPaymentStatusConstant.SERVICE_PREFIX + pisCommonPaymentResponse.getPaymentType().getValue());
    }
