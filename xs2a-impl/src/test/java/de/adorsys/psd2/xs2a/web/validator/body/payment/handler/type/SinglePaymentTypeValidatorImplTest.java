...
class SinglePaymentTypeValidatorImplTest {
    ...
    private static final String VALUE_141_LENGHT = "BaYRKDrBPFcAP7qsEaYcjqO98KQNtDWUG4ilvUNcRDp1uEKEAtFy5oygoAbEvpiNdSLdmaJjzOWlOmLgtLpO5w70DKxBDZPc82qkCELD37rGjobkk3ZqfIYOxCTVNtHoyyycV0prpFL42";
    ...
    void doValidation_remittance_reference_issuer_error() {
        singlePayment.setRemittanceInformationStructured(VALUE_141_LENGHT);
    ...
    void doSingleValidation_remittanceInformationStructuredArray_reference_error() {
        singlePayment.setRemittanceInformationStructuredArray(Collections.singletonList(VALUE_141_LENGHT));
