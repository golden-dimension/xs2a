...
class CreateConsentLinksTest {
    ...
    void scaApproachRedirect_OauthPreStep_AndImplicitMethod() {
        ...
        // When
        links = new CreateConsentLinks(HTTP_URL, scaApproachResolver, response, redirectLinkBuilder, redirectIdService, false, false, ScaRedirectFlow.OAUTH_PRE_STEP, false, "");
