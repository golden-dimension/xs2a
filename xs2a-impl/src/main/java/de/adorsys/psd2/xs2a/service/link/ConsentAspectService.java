...
public class ConsentAspectService extends BaseAspectService<ConsentController> {
    ...
    public ResponseObject<CreateConsentResponse> invokeCreateAccountConsentAspect(ResponseObject<CreateConsentResponse> result,
        ...
        if (!result.hasError()) {
            ...
            LinksFieldHolder fieldHolder = LinksFieldHolder.builder()
                ...
                .build();
            body.setLinks(new CreateConsentLinks(fieldHolder, scaApproachResolver, body, redirectLinkBuilder,
                                                 redirectIdService,
                                                 getScaRedirectFlow()));
        }
        return result;
        ...
        if (!result.hasError()) {
            if (result.getBody() instanceof UpdateConsentPsuDataResponse) {
                ...
                LinksFieldHolder fieldHolder = LinksFieldHolder.builder()
                    ...
                    .instanceId(requestProviderService.getInstanceId())
                    .build();
                body.setLinks(new CreateAisAuthorisationLinks(fieldHolder, body, scaApproachResolver, redirectLinkBuilder,
    ...
    public ResponseObject<Xs2aConfirmationOfFundsResponse> createPiisConsentWithResponse(ResponseObject<Xs2aConfirmationOfFundsResponse> result, boolean explicitPreferred) {
        if (!result.hasError()) {
            ...
            body.setLinks(new CreatePiisConsentLinks(fieldHolder, scaApproachResolver, body, redirectLinkBuilder,
                                                     redirectIdService,
                                                     getScaRedirectFlow()));
        }
        return result;
        ...
        if (!result.hasError()) {
            if (result.getBody() instanceof UpdateConsentPsuDataResponse) {
                ...
                LinksFieldHolder fieldHolder = LinksFieldHolder.builder()
                    ...
                    .instanceId(requestProviderService.getInstanceId())
                    .build();
                body.setLinks(new CreatePiisAuthorisationLinks(fieldHolder, body, scaApproachResolver, redirectLinkBuilder,
                                                               redirectIdService, getScaRedirectFlow()));
            }
        }
        return result;
