...
@Data
@Service
public class QwacCertificateFilterMappersHolder {
    ...
    public List<TppRole> mapToTppRoles(List<String> rolesList) {
        return tppInfoRolesMapper.mapToTppRoles(rolesList);
    }

    public TppInfo mapToTppInfo(TppCertificateData tppCertificateData) {
        return xs2aTppInfoMapper.mapToTppInfo(tppCertificateData);
    }
}
