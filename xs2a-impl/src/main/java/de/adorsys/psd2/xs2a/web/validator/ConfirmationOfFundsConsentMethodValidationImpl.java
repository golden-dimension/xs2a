...
import de.adorsys.psd2.xs2a.web.validator.header.ConfirmationOfFundsHeaderValidator;
...
public class ConfirmationOfFundsConsentMethodValidationImpl extends AbstractMethodValidator {
    ...
    public ConfirmationOfFundsConsentMethodValidationImpl(List<ConfirmationOfFundsHeaderValidator> headerValidators, List<ConfirmationOfFundsConsentBodyValidator> bodyValidators) {
