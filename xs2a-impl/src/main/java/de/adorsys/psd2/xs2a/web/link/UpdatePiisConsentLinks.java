...
public class UpdatePiisConsentLinks extends AbstractLinks {

    public UpdatePiisConsentLinks(String httpUrl, ScaApproachResolver scaApproachResolver, UpdateConsentPsuDataResponse response) {
        super(httpUrl);
        ...
        HrefType authorisationLink = buildPath(UrlHolder.PIIS_AUTHORISATION_URL, consentId, authorisationId);
