...
@Component
public class TppExplicitAuthorisationPreferredHeaderValidatorImpl extends AbstractHeaderValidatorImpl
    implements ConsentHeaderValidator, PaymentHeaderValidator, CancelPaymentHeaderValidator {

    @Autowired
    public TppExplicitAuthorisationPreferredHeaderValidatorImpl(ErrorBuildingService errorBuildingService) {
