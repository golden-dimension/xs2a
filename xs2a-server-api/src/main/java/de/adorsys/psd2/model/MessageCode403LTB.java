 ...
 */
@ApiModel(description = "Message codes defined for Trusted Beneficiaries for HTTP Error code 403 (FORBIDDEN).")
@Validated
...
public class MessageCode403LTB   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode403LTB {\n");
