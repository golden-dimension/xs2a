 ...
 */
@ApiModel(description = "Message codes defined for Trusted Beneficiaries for HTTP Error code 405 (METHOD NOT ALLOWED).")
@Validated
...
public class MessageCode405LTB   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode405LTB {\n");
