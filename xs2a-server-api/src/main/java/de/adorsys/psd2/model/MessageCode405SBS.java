 ...
 */
@ApiModel(description = "Message codes defined for SBS for HTTP Error code 405 (METHOD NOT ALLOWED).")
@Validated
...
public class MessageCode405SBS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode405SBS {\n");
