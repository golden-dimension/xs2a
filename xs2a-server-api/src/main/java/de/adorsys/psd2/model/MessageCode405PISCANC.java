 ...
 */
@ApiModel(description = "Message codes defined for payment cancelations PIS for HTTP Error code 405 (METHOD NOT ALLOWED).")
@Validated
...
public class MessageCode405PISCANC   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode405PISCANC {\n");
