 ...
 */
@ApiModel(description = "Message codes defined for PIS for HTTP Error code 401 (UNAUTHORIZED).")
@Validated
...
public class MessageCode401PIS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode401PIS {\n");
