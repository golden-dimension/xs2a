...
@Size(max=70)
  ...
  public Error400LTBAdditionalErrors detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass()) {
      return false;
}    Error400LTBAdditionalErrors error400LTBAdditionalErrors = (Error400LTBAdditionalErrors) o;
    return Objects.equals(this.title, error400LTBAdditionalErrors.title) &&
    Objects.equals(this.detail, error400LTBAdditionalErrors.detail) &&
    Objects.equals(this.code, error400LTBAdditionalErrors.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class Error400LTBAdditionalErrors {\n");
