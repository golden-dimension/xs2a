 ...
 */
@ApiModel(description = "Message codes defined for signing baskets for HTTP Error code 403 (FORBIDDEN).")
@Validated
...
public class MessageCode403SBS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode403SBS {\n");
