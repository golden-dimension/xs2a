...
public class Error405LTB   {
  ...
  @Valid
  private List<Error405LTBAdditionalErrors> additionalErrors = null;

  @JsonProperty("_links")
  private Map _links = null;

  public Error405LTB type(String type) {
    this.type = type;
    return this;
  }
...
@Size(max=70)
  ...
  public Error405LTB title(String title) {
    this.title = title;
    return this;
  }
...
@Size(max=70)
  ...
  public Error405LTB detail(String detail) {
    this.detail = detail;
    return this;
  }
...
@Size(max=500)
  ...
  **/
  ...
  public Error405LTB additionalErrors(List<Error405LTBAdditionalErrors> additionalErrors) {
    this.additionalErrors = additionalErrors;
    return this;
  }

  public Error405LTB addAdditionalErrorsItem(Error405LTBAdditionalErrors additionalErrorsItem) {
  ...
  **/
  ...
  @JsonProperty("additionalErrors")
  public List<Error405LTBAdditionalErrors> getAdditionalErrors() {
    return additionalErrors;
  }

  public void setAdditionalErrors(List<Error405LTBAdditionalErrors> additionalErrors) {
    this.additionalErrors = additionalErrors;
  }

  public Error405LTB _links(Map _links) {
    this._links = _links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass()) {
      return false;
}    Error405LTB error405LTB = (Error405LTB) o;
    return Objects.equals(this.type, error405LTB.type) &&
    Objects.equals(this.title, error405LTB.title) &&
    Objects.equals(this.detail, error405LTB.detail) &&
    Objects.equals(this.code, error405LTB.code) &&
    Objects.equals(this.additionalErrors, error405LTB.additionalErrors) &&
    Objects.equals(this._links, error405LTB._links);
  }
