 ...
 */
@ApiModel(description = "Message codes defined for signing baskets for HTTP Error code 409 (CONFLICT).")
@Validated
...
public class MessageCode409SBS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode409SBS {\n");
