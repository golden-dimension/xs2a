 ...
 */
@ApiModel(description = "Message codes defined for AIS for HTTP Error code 405 (METHOD NOT ALLOWED).")
@Validated
...
public class MessageCode405AIS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode405AIS {\n");
