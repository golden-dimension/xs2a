 ...
 */
@ApiModel(description = "Message codes defined for PIIS for HTTP Error code 405 (METHOD NOT ALLOWED).")
@Validated
...
public class MessageCode405PIIS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode405PIIS {\n");
