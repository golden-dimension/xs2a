 ...
 */
@ApiModel(description = "Message codes defined for PIIS for HTTP Error code 404 (NOT FOUND).")
@Validated
...
public class MessageCode404PIIS   {
  ...
  public String toString() {
    ...
    sb.append("class MessageCode404PIIS {\n");
